...
penal_weights = utils.cross_val(dat=dat,
                               penal_fun=reg_opt.symmetric_penal3,
                               splits=lams,
                               n_folds=5,
                               m_p_corr=w_corr,
                               key = key)
...
df_cv.to_csv("../results/luad/cross_validation_results_31.csv", index=False)
...
theta, d_p, d_m= reg_opt.learn_mhn(th_init=th_init,
                                   ...
                                   dat=dat,
                                   perc_met=0.2,
                                   penal=reg_opt.symmetric_penal3,
                                   w_penal=0.001,
                                   fixed_grad = True,
                                   opt_ftol=1e-05
                                   )
...
df_loglik.to_csv("../results/luad/final_loglik_31.csv", index=False)
...
df2.to_csv("../results/luad/luad_g14_10muts_31.csv")
