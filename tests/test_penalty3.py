...
df_cv.to_csv("../results/luad/cross_validation_results_3.csv", index=False)
...
df_loglik.to_csv("../results/luad/final_loglik_3.csv", index=False)
...
df2.to_csv("../results/luad/luad_g14_10muts_3.csv")
