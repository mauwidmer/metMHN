...
df_cv.to_csv("../results/luad/cross_validation_results_2.csv", index=False)
...
df_loglik.to_csv("../results/luad/final_loglik_2.csv", index=False)
...
df2.to_csv("../results/luad/luad_g14_10muts_2.csv")
